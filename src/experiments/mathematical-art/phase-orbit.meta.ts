...
export default {
  experiment: {
    ...
    runtime: 'canvas',
    mathFunction: 'a(y,d)=mag(k=5 cos(i/44), e=y/2−15)/3; point(x,y)=((79+d²+k²)sin(c)+200, 99 cos(c/3)+(9/d)sin(2k)+(y/(77 sin(e/2)+10⁻⁴))ke+d³/d cos(3t−d²/4)+200), c=d/2−t/3+9(i mod 2), y=i/285',
